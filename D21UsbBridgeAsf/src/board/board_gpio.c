...
static struct mux_config g_board_ports_list[] =
{
    ...
    */
    ...
    {PINMUX_PB04B_ADC_AIN12, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB05B_ADC_AIN13, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB06B_ADC_AIN14, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB07B_ADC_AIN15, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB08B_ADC_AIN2, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB09B_ADC_AIN3, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PA05B_ADC_AIN5, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PA06B_ADC_AIN6, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PA09B_ADC_AIN17, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PA10B_ADC_AIN18, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PA11B_ADC_AIN19, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB00B_ADC_AIN8, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB01B_ADC_AIN9, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB02B_ADC_AIN10, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
    {PINMUX_PB03B_ADC_AIN11, SYSTEM_PINMUX_PIN_DIR_INPUT, SYSTEM_PINMUX_PIN_PULL_NONE, false},
};
